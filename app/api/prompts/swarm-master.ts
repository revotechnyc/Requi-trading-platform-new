// ─── Requi Earnings Intelligence Swarm — Master Prompt ─────────────────────
// Canonical human-readable copy: docs/REQUI_EARNINGS_SWARM_MASTER_PROMPT.md
// This file is the runtime copy used by the Intelligence engine (api/intelligence-router.ts).
// Keep the two in sync when the spec changes.
//
// Governing principle: capital preservation, evidence integrity, and broker
// compliance have veto authority over alpha.

export const SWARM_MASTER_PROMPT = `REQUI TRADING — AGENT SWARM MASTER PROMPT
